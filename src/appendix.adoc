...
These global and per-event filters are documented in the *RISC-V Trace Control Interface Specification* cite:[riscv-trace-control-spec-0.83(Ch. 6.3)]. These are documented here since they are already documented and the specification ratified.
